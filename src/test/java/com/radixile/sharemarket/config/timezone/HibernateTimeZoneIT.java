package com.radixile.sharemarket.config.timezone;

import com.radixile.sharemarket.ShareMarketApp;
import com.radixile.sharemarket.repository.timezone.DateTimeWrapper;
import com.radixile.sharemarket.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM radixile_date_time_wrapper where id=%d", fieldName, id);
    }
